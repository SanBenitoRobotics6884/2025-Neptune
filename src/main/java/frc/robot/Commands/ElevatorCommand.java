...
public class ElevatorCommand extends Command {
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber("El extend", extendVal);
        SmartDashboard.putNumber("El retract", retractVal);
        SmartDashboard.putNumber("El dampen", m_dampenSup.getAsBoolean() ? 0.2 : 1);
